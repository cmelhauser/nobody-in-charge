...
fast; read as practice it is untested. In the one-at-a-time screen, downward moves of
$\delta_0$ of 25 per cent or more reverse the ordering of referral loss against pure attraction
loss on final membership, so that ordering is conditional on practice lapsing at roughly the
assumed rate.
