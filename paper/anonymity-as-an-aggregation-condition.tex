...
\author{\normalsize Human Author: Christopher Melhauser\\
\normalsize AI Writing Collaborator: theonlymuffinbot\\
\small Anthropic Claude Opus 5; OpenAI GPT-5.6 Sol and Terra}
\date{\normalsize August 2026\\[0.25em]
\small Released to the public domain under The Unlicense.}
...
Humphreys, and Ferri 2020) finds, with high certainty, that manualized interventions
raise continuous abstinence at twelve months over established alternatives such as
cognitive behavioral therapy (two trials, 1,936 participants), and that they do about
as well on most other drinking outcomes. Most of the mechanism literature credits
changes in a participant's social network: Kaskutas, Bond, and Humphreys (2002) find
that AA's effect on drinking outcomes is mediated substantially by changes in the
network's composition. The clearest dissent is Rynes and Tonigan (2012), whose fully
lagged prospective design finds that the benefit of having a sponsor is not carried
by change in the abstinent social network. Measurement instruments for affiliation and
...
al.\ 2007; Sharma and Samanta 2015). Agent-based work has modeled drinking as social
contagion among agents moving between locations, one of which is a bar that
concentrates drinkers (Gorman et al.\ 2006).
...
substitution parameter as $\phi$ and reserve $\rho$ for an outcome share; $\rho$ here is our
notation.) Self-productivity is
...
empirical identification design; the calculation here does not estimate it. In the one
setting where an analogous parameter has been estimated, children's skill formation, Cunha,
Heckman, and Schennach (2010) find it positive in early childhood and strongly negative later
for cognitive skill, and negative at both stages for noncognitive skill, so there is no reason
to expect a single sign across all twelve Steps.
...
\item \textbf{The decay rate is uncalibrated and consequential.} $\delta_0$ is second only
to $p$ in every sensitivity design. The two estimates read for anything comparable measure
skills, not practices: Dinerstein, Megalokonomou, and Yannelis (2022) put the depreciation of
teaching skill at 4.3 per cent a year for early-career teachers, and Cohen, Johnston, and
Lindner (2023) find no measurable decline in cognitive skills over up to three years of
unemployment. Read as skill, $\delta_0 = 0.06$ per week is one to two orders of magnitude too
fast; read as practice it is untested. A search of the literature on how fast practices lapse
brackets it rather than calibrating it. Edgren, Baretta, and Inauen (2025), the first intensive
longitudinal study of habit decay in daily life, find self-reported automaticity settling in a
median of 9 to 10 days (range 1 to 65) among people deliberately degrading an unwanted habit,
an order of magnitude faster than $\delta_0$ and a different object: a habit actively removed,
not a practice left unrenewed. Kaskutas, Bond, and Avalos (2009) give the other end from inside
AA, with four attendance trajectories over seven years in which participation falls away on a
scale of years and abstinence does not follow it down, which also cautions against reading the
practice variable as a meeting count. The one-at-a-time screen found that lowering $\delta_0$
by 25 per cent or more reverses the ordering of referral loss against pure attraction loss on
final membership, and a 400-seed run paired by common random numbers, over 1,560 weeks at
$dt = 0.5$ with full adherence otherwise, confirms it and bounds it. At 25 per cent lower,
referral loss leaves the larger group, by 14.97 members [12.73, 17.21], but remains worse on
endpoint viability, by 0.2450 [0.2028, 0.2872], and on existence, by 0.1600 [0.1240, 0.1960];
at 50 and 75 per cent lower every referral-loss run is endpoint-viable. A second run on the same
design, at 10, 15 and 20 per cent lower, locates the membership reversal between 15 and 20 per
cent: the ordering holds at 10.92 members [10.18, 11.66] and 6.35 [5.03, 7.68] respectively, and
is reversed at $-2.79$ [$-4.77$, $-0.81$], while endpoint viability and existence are reversed in
no paired run at any of the three. The ordering is therefore
conditional on practice lapsing at roughly the assumed rate, and at slower rates which loss is
worse depends on the outcome scored.
...
\item Angrist, J. D. (2014). ``The perils of peer effects.'' \textit{Labour Economics} 30: 98-108. \textbf{Read in full} in its working-paper version.

\item Banks, H. T., K. L. Rehm, K. L. Sutton, C. Davis, L. Hail, A. Kuerbis, and J. Morgenstern (2014). ``Dynamic modeling of behavior change.'' \textit{Quarterly of Applied Mathematics} 72(2): 209-251. \textbf{Cited at a remove}, through Banks et al.\ (2017).

\item Banks, H. T., K. Bekele-Maxwell, R. A. Everett, L. Stephenson, S. Shao, and J. Morgenstern (2017). ``Dynamic modeling of problem drinkers undergoing behavioral treatment.'' \textit{Bulletin of Mathematical Biology} 79(6): 1254-1273. \textbf{Read in full} in its author-manuscript version.

\item Ben-Porath, Y. (1967). ``The production of human capital and the life cycle of earnings.'' \textit{Journal of Political Economy} 75(4): 352-365. \textbf{Read at source}.
...
\item Cohen, J. P., A. C. Johnston, and A. S. Lindner (2023). ``Skill depreciation during unemployment: Evidence from panel data.'' NBER Working Paper 31120. \textbf{Read in full} apart from its appendices.
...
\item Cunha, F., and J. J. Heckman (2007). ``The technology of skill formation.'' \textit{American Economic Review} 97(2): 31-47. \textbf{Read in full} in its working-paper version.

\item Cunha, F., J. J. Heckman, and S. M. Schennach (2010). ``Estimating the technology of cognitive and noncognitive skill formation.'' \textit{Econometrica} 78(3): 883-931. \textbf{Read in full} in its working-paper version.
...
\item Dinerstein, M., R. Megalokonomou, and C. Yannelis (2022). ``Human capital depreciation and returns to experience.'' NBER Working Paper 27925. \textbf{Read in full} apart from its online appendix.

\item Edgren, R., D. Baretta, and J. Inauen (2025). ``The temporal trajectories of habit decay in daily life: An intensive longitudinal study on four health-risk behaviors.'' \textit{Applied Psychology: Health and Well-Being} 17(1): e12612. \textbf{Read in full} apart from its supplement, figures, and references; open access under CC BY 4.0.
...
\item Gorman, D. M., J. Mezic, I. Mezic, and P. J. Gruenewald (2006). ``Agent-based modeling of drinking behavior: A preliminary model and potential applications to theory and practice.'' \textit{American Journal of Public Health} 96(11): 2055-2060. \textbf{Read in full}.
...
\item Hu, Y., and S. M. Schennach (2008). ``Instrumental variable treatment of nonclassical measurement error models.'' \textit{Econometrica} 76(1): 195-216. \textbf{Read in part}; used here at a remove, through Cunha, Heckman, and Schennach.
...
\item Kaskutas, L. A., J. Bond, and L. A. Avalos (2009). ``7-year trajectories of Alcoholics Anonymous attendance and associations with treatment.'' \textit{Addictive Behaviors} 34(12): 1029-1035. \textbf{Read in full} apart from its three figures, as the NIH author manuscript.

\item Kelly, J. F., K. Humphreys, and M. Ferri (2020). ``Alcoholics Anonymous and other 12-step programs for alcohol use disorder.'' \textit{Cochrane Database of Systematic Reviews}, CD012880. \textbf{Read in full} apart from its per-study tables, analyses and appendices.
...
\item Lembke, A. (n.d.). ``Sacrifice, stigma, and free-riding in Alcoholics Anonymous.'' Association for the Study of Religion, Economics and Culture. \textbf{Read in full.}
...
\item Rynes, K. N., and J. S. Tonigan (2012). ``Do social networks explain 12-step sponsorship effects? A prospective lagged mediation analysis.'' \textit{Psychology of Addictive Behaviors} 26(3): 432-439. \textbf{Read in full} in its author-manuscript version.
...
\item Witkiewitz, K., and G. A. Marlatt (2007). ``Modeling the complexity of post-treatment drinking: It's a rocky road to relapse.'' \textit{Clinical Psychology Review} 27(6): 724-738. \textbf{Read in full} in its author-manuscript version.
...
whose original has not been traced. The literature on how fast practices and habits lapse,
