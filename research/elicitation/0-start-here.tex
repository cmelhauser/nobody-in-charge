...
\texttt{5-invitation-email.md} & you, to paste into an email \\
\bottomrule
\end{tabular}
\end{center}
...
\item \textbf{Send them \texttt{1-respondent-form}} and the note in \texttt{2-recruiting-note},
      or the ready-to-send message in \texttt{5-invitation-email.md}, which adds the subject
      lines, the attachment check, answers to the questions respondents actually ask, a nudge and
      a thank-you. Twenty to forty minutes of work for them.

      Ask the respondents not to compare notes with each other until every form is back, and keep
      your own replies to their questions short: the likeliest way to spoil the round is a helpful
