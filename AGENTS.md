...
3. **Do not restart a completed analysis.** All nineteen caches are complete and hash-current.
...
Five of the 40 sources are **record only**: no document exists at any time, which is a stronger
