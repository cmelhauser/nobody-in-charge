...
where λ_exog is the referral floor, Σx₁₂ is total twelfth-step practice summed across members, and T₁₁ is adherence to the attraction principle. Setting λ_exog = 0, the 1840 condition, makes inflow strictly proportional to current member activity, with no additive term.
